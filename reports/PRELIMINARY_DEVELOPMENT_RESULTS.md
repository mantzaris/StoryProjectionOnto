...
Historical allocation 6716.108081 s; this phase 1484.317083 s; cumulative 8200.425164 s. Open GPU/service journals: 0/0. The phase ceiling is 3,600 s. The global scheduled/hard limits remain 33,660/36,000 s; no complete-study admission is claimed.

Service starts: 4; transmitted HTTP requests: 6; responses with generation tokens: 5; reserved attempts: 7. The continuation allows at most 4 total starts within the same phase. Transmitted parent repairs: 3. vLLM is stopped; the pod remains intact. No further phase is initiated.

Peak sampled GPU VRAM / process RAM / project occupancy (bytes): 22793945088 / 7124774912 / 16960844288. These are sampled peaks, not continuous maximum guarantees. Terminal full storage checks passed.
...
Unvalidated legacy remaining-work proxy: 40162.013213 s; all-in with preserved actual allocation: 48362.438377 s. This is not a calibrated production forecast. Failed completion speeds receive no credit. The original nine-hour target was not met; the amended scheduled ceiling remains unchanged.
