#!/usr/bin/env python3
"""Restore the exact incident-bound fallback-v8 terminal service lease."""
...
from story_projection_onto.fallback_v8_lease_repair import (  # noqa: E402
...
def parse_arguments(arguments: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--stop-intent", type=Path, required=True)
...
def main(arguments: Sequence[str] | None = None) -> int:
    ...
    restore_fallback_v8_terminal_lease(
        ...
        stop_intent_path=options.stop_intent,
