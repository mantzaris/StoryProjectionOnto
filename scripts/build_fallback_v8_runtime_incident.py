#!/usr/bin/env python3
"""Build the public terminal fallback-v8 runtime incident record."""
...
from story_projection_onto.fallback_v8_runtime_incident import (  # noqa: E402
    FALLBACK_V8_RUN_ID,
...
def parse_arguments(arguments: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--run-id", default=FALLBACK_V8_RUN_ID)
    ...
    parser.add_argument("--manual-recovery-root", type=Path, required=True)
    parser.add_argument("--ledger-before-v8", type=Path, required=True)
...
def main(arguments: Sequence[str] | None = None) -> int:
    ...
    incident = build_fallback_v8_runtime_incident(
