#!/usr/bin/env python3
"""Build the public, zero-GPU fallback-v4 control-plane incident record."""
...
from story_projection_onto.fallback_control_plane_incident import (  # noqa: E402
    FALLBACK_V4_RUN_ID,
...
def parse_arguments(arguments: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--run-id", default=FALLBACK_V4_RUN_ID)
...
def main(arguments: Sequence[str] | None = None) -> int:
    ...
    incident = build_fallback_control_plane_incident(
    ...
    write_fallback_control_plane_incident(options.output, incident)
    return 0
